...
export default function Status_menu() {
    ...
    const handleSubmit = async () => {
        try {
            ...
            const response = await axios.post(`${import.meta.env.VITE_APP_API_BASE_URL}/api/status/create-status`, {
                ...formData,
                ...
                <Paper sx={{ width: { xs: '340px', xl: '1200px' }, padding: '40px' }}>
                    <Grid container spacing={2}>
                        <Container maxWidth="sm">
                            <TextField label="ชื่อสถานะ" variant="outlined" fullWidth sx={{ marginTop: '10px' }} onChange={(e) => handleInputChange('status_name', e.target.value)} />
