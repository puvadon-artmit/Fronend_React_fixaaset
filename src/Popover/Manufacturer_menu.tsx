...
export default function Manufacturer_menu() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await axios.post(`${import.meta.env.VITE_APP_API_BASE_URL}/api/manufacturer/create-manufacturer`, {
        ...formData,
        user_id: username.user_id,
        type_id : manufacturer
      });
        ...
        <Paper sx={{ width: { xs: '340px', xl: '1200px' }, padding: '40px' }}>
          <Grid container spacing={2}>
            <Container maxWidth="sm">
              <TextField label="ชื่อผู้ผลิต" variant="outlined" fullWidth sx={{ marginTop: '10px' }} onChange={(e) => handleInputChange('manufacturer_name', e.target.value)} />
