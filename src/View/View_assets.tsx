...
export default function View_assets() {
    ...
    const handleExportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, 'สินทรพย์ทั้งหมด');
        XLSX.writeFile(wb, 'สินทรพย์ทั้งหมด.xlsx');
    };
    ...
    return (
        <div>
            <Container maxWidth="xl">
                ...
                <h1 className='text-center text-3xl'>สินทรัพย์ทั้งหมด</h1>
                ...
                <button className="flex mt-8 items-center text-white bg-green-600 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-3 py-1.5 me-2 mb-2" onClick={handleExportToExcel}>
                                                ...
                                                {columns.map((column) => (
                                                    <TableCell
                                                        ...
                                                        {column.id === 'model_name' ? (
                                                            <Link to={`/assets/view_model/detail_ground/${row.assets_id}`}>
                                                                {row[column.id]}
                                                            </Link>
                                                        ) : (
                                                            row[column.id]
