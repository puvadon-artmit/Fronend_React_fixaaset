...
const columns: readonly Column[] = [
    { id: 'status_name', label: 'ชื่อสถานะ', minWidth: 170 },
...
function View_status() {
    const [status_name, setStatus_name] = useState<Data[]>([]);
    ...
    const fetchSubnets = async () => {
        try {
            const response = await axios.get(`${import.meta.env.VITE_APP_API_BASE_URL}/api/status/get-status`);
